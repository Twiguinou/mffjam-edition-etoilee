...
public class CapsuleSmall extends AMountableRocketPart {

    public CapsuleSmall(EntityType<?> entityTypeIn, World worldIn) {
    ...
    protected OrientedBoundingBox getOrientedCollisionBox() {
        return new OrientedBoundingBox(-0.5D, -1.0D, -0.5D, 0.5D, -0.25D, 0.5D);
    }
